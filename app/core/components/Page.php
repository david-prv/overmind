...
class Page
{
        ...
        $noScript = <<<HTML
            <noscript>
                ...
                <div class="no-script">
                    ...
                    <p>Please enable JavaScript in your browser in order to render a page!</p>
                </div>
            </noscript>
        HTML;
    ...
    {
        $noScript = <<<HTML
            <div class="no-mobile-notice" style="display:none;">
                <style>
                    .no-mobile-notice-message {
                        padding-top:10%!important;
                        height:100vh;
                        width:100vw;
                        background:white;
                ...
                <div class="no-mobile-notice-message">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-exclamation-octagon-fill" viewBox="0 0 16 16">
                      <path d="M11.46.146A.5.5 0 0 0 11.107 0H4.893a.5.5 0 0 0-.353.146L.146 4.54A.5.5 0 0 0 0 4.893v6.214a.5.5 0 0 0 .146.353l4.394 4.394a.5.5 0 0 0 .353.146h6.214a.5.5 0 0 0 .353-.146l4.394-4.394a.5.5 0 0 0 .146-.353V4.893a.5.5 0 0 0-.146-.353L11.46.146zM8 4c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995A.905.905 0 0 1 8 4zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                    </svg>
                    <p></p>
                    <h2>Unexpected Error</h2>
                    <p>Page is not available for mobile devices!</p>
                </div>
            </div>
        HTML;

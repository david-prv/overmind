...
try:
    ...
    if rcode == 200 :
        ...
        robotres = requests.get(sys.argv[1] + "/wp-config.php",headers=headers)

        if robotres.status_code == 200 :
            ...
            print(Lyellw+'\n[-] WordPress Detection : No (config)', robotres.status_code)
    else :
        print(Lyellw+'\n[-] WordPress Detection : No (json)', rcode)
...
function update()
{
  echo "[+] RED HAWK UPDATE UTILITY [+]\nUpdate in progress, please wait...\n\n";
  system("git fetch origin && git reset --hard origin/master && git clean -f -d");
  echo  "[i] Job finished successfully! Please Restart RED HAWK \n";
  exit;
}
...
$ip = explode("://", $argv[1])[1]; //trim(fgets(STDIN, 1024));
if ($ip == "help")
{
...
else
{
  ...
  else
  {
    ...
    elseif ($scan == "0")
    {
      ...
      echo $blue . $bold . "[i] Scanning Site: $ipsl" . "$ip \n";
      ...
      WEBserver($reallink);
      echo "\n";
      echo $bold . $lblue . "[iNFO] CMS: " . CMSdetect($reallink) . $cln;
      echo $lblue . $bold . "\n[iNFO] Cloudflare: ";
    ...
    elseif ($scan == "11")
    {
      ...
      echo "\n$cln" . $lblue . $bold . "[+] Scanning Begins ... \n";
      echo $blue . $bold . "[i] Scanning Site: $reallink \n";
    ...
    elseif ($scan == "A" || $scan == "a")
    {
      ...
      echo "$blue" . "[i] Scanning Site: $ipsl" . "$ip \n";
      echo "\n\n";
      ...
      echo "$blue" . "[+] CMS: " . CMSdetect($reallink) . " ";
      ...
      die();
      $ctype = "69"; //trim(fgets(STDIN, 1024));
      if ($ctype == "420")
      {

...
<div class="container p-3">
    ...
    <div>
        <p style=" border-left: 4px solid blue;padding: 0.5em;">
            Below, you can see the preview for the report PDF, generated by the scanner-bundle framework, based on your
            recent scan result. You can edit the contents of the tables and add an optional comment at the end. If you're
            done editing the PDF, press the button to generate and safe the final report as PDF.
        </p>
    </div>

    <button class="btn btn-primary mb-4" id="button"><i class="fa fa-cogs"></i> Generate PDF</button>

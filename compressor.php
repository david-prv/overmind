...
$path = getcwd();
$js_files = array("bundle", "schedule", "hotkeys", "reference", "dropzone", "prototype", "toasts", "integrate");
...
if (substr_compare($path, "overmind", -strlen("overmind")) !== 0 && substr_compare($path, "overmind-main", -strlen("overmind-main")) !== 0) {
